...
//   States
  ...
  const token = JSON.parse(localStorage.getItem("tastytoken"));
    ...
    const resetImage = () => {
      ...
      setImagePreview(null); // Clear the image preview when resetting
    };
  ...
  <div>
    ...
    />
    {/* Button to allow re-upload */}
    <button
          onClick={resetImage} // Reset the selected image and preview
          className="inline-flex items-center bg-red-700 border-0 py-1 px-3 focus:outline-none hover:bg-red-500 rounded text-white mt-4 md:mt-4 transition-all"
        >
          Change Image
        </button>
