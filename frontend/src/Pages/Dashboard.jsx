    ...
    <div id="userDashboard" className="border-gray-200 border-t-[1px]">
      <div className="grid md:grid-cols-[70%_30%] grid-cols-1 relative">
        <div className="p-16 h-[100vh] relative overflow-y-scroll max-w-[100%]">
          ...
          <nav className="md:ml-auto md:mr-auto flex flex-wrap items-start text-base justify-start border-b border-gray-200">
          ...
          <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-4 py-8 mx-auto">
              {loading ? (
                ...
                <div className="flex justify-center flex-col items-center h-auto w-auto py-10 overflow-hidden">
                  <img
                    src="/assets/errorimg4.svg"
                    alt="Cover"
                    className="object-cover rounded-md w-[60%]"
                  />
                  <p className="text-2xl text-red-500">
                    Let's cook some delicious recipes
                  </p>
                </div>
              ) : (
